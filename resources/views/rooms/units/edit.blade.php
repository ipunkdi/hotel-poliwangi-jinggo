    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse px-4 lg:px-12">
            ...
            <div class="flex items-center">
                ...
                <a href="/rooms/{{ $inventory->unit->name }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ $inventory->unit->name }}</a>
            </div>
            </li>
            <li>
            <div class="flex items-center">
